...
<body>
  <nav class="navbar sticky-top navbar-expand-sm navbar-light bg-light justify-content-between">
    ...
    <div class="navbar-nav dropdown" style="display: flex; flex-direction: row;">
      ...
      <a class="btn btn-secondary" type="button" href="#" data-toggle="modal" data-target="#modal-dolly-programa">Acerca de Dolly</a>
  </nav>
  ...
  <div class="container">
   ...
   <div class="modal" tabindex="-1" role="dialog" id="modal-dolly-programa">
    ...
    <div class="alert alert-warning alert-dismissible collapse" role="alert" id="advertencia">
      <h6>Cursos ordenados segun 1Q 2020.</h6>
      Proximamente Dolly te mostrara los cursos del 2Q 2020!!
      <button type="button" class="close" data-dismiss="alert" aria-label="Close">
        <span aria-hidden="true">&times;</span>
      </button>
    </div>
    ...
    <div class="table-responsive">
      ...
      <thead>
        <tr>
          <h6>Cursos ordenados segun 1Q 2020</h6>
          <p>Proximamente Dolly te mostrara los cursos del 2Q 2020!!</p>
        </tr>
...
<script id="chatBroEmbedCode">/* Chatbro Widget Embed Code Start */function ChatbroLoader(chats,async){async=!1!==async;var params={embedChatsParameters:chats instanceof Array?chats:[chats],lang:navigator.language||navigator.userLanguage,needLoadCode:'undefined'==typeof Chatbro,embedParamsVersion:localStorage.embedParamsVersion,chatbroScriptVersion:localStorage.chatbroScriptVersion},xhr=new XMLHttpRequest;xhr.withCredentials=!0,xhr.onload=function(){eval(xhr.responseText)},xhr.onerror=function(){console.error('Chatbro loading error')},xhr.open('GET','//www.chatbro.com/embed.js?'+btoa(unescape(encodeURIComponent(JSON.stringify(params)))),async),xhr.send()}/* Chatbro Widget Embed Code End */ChatbroLoader({encodedChatId: '96ieg'});</script>
</body>
</html>
