...
$(function(){
  Equivalency.init(function(st){
    ...
    getJSON("http://127.0.0.1:3000/comun", function(data,st){
      ...
      getJSON("http://127.0.0.1:3000/valoraciones", function(data,st){
        // Prepare keys
        ...
        // Load comments
        getJSON("http://127.0.0.1:3000/comentarios", function(data,st){
          // Decode
          d=data;
